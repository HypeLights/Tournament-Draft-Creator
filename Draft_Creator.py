...
layout = [
    ...
    [
        ...
        sg.InputText("", key="-TEAMS-"),
    ],
    [
        sg.Text("How many teams do you want?", size=(30, 1)),
        sg.InputText("", key="-COUNT-"),
    ],
    [
    ...
    [
        sg.Button("Calculate!", button_color=("#006000"), mouseover_colors=("#008000")),
        sg.Button(
            "Clear Output",
            button_color=("#9e6515"),
            mouseover_colors=("#bf7a19"),
            size=(9, 1),
        ),
        sg.Button("Exit", button_color=("#8A0000"), mouseover_colors=("#ad0000")),
    ],
...
try:
        ...
        if event is None or event == "Exit":
            ...
            if location != "":
                if location.endswith(".csv"):
                    ...
                    print(
                        "The file isnt a csv file! Make sure to download the sheet as csv!\n"
                    )
            if error > 0:
                if error > 1:
                ...
                for Team in Teams:
                    ...
                    for player in Team:
                        if All == True:
                            print(
                                f"<@{player.id}>", "-", player.name, "-", player.skill
                            )
                        else:
                            print(f"<@{player.id}>")
                print()
    ...
    sg.Print(
        f"An error happened. Ping HypeLights with a screenshot of this.  Here is the info:",
        e,
        tb,
    )
